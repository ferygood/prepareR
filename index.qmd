...
\<\<\<\<\<\<\< HEAD 2. Download RStudio here: [[**RStudio for Macs**]{.underline}](https://download1.rstudio.org/electron/macos/RStudio-2024.04.1-748.dmg) [**,[RStudio for Ubuntu](https://download1.rstudio.org/electron/focal/amd64/rstudio-2024.04.1-748-amd64.deb)**]{.underline} and follow the instructions.
